...
public class ProductsAppApplication {
    ...
    CommandLineRunner start(ProductRepository productRepository){
        return args -> {
            productRepository.save(new Product(null,"souris",7600,34));
            productRepository.save(new Product(null,"ecran",1600,134));
            productRepository.save(new Product(null,"iphone",1600,34));
        };
    }
